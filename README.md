...
<body class="bg-gray-100 text-gray-800">
    ...
    <div class="container mx-auto p-4 md:p-8">
        <header class="text-center mb-6">
            ...
            <p class="text-md text-gray-600 mt-2">Laporan Kerja untuk Pembaruan Tekanan Valve</p>
        </header>

        <!-- Controls -->
        <div class="mb-6 p-4 bg-white rounded-lg shadow-md space-y-4">
            <div>
                <h2 class="text-lg font-semibold mb-3 text-gray-700">Mode Input</h2>
                <div class="flex flex-wrap items-center gap-3">
                    <label for="shift-selector-label" class="font-medium">Pilih Shift:</label>
                    <div id="shift-selector" class="flex flex-wrap gap-3">
                        <button data-shift="1" class="shift-btn bg-blue-600 text-white py-2 px-5 rounded-lg font-semibold shadow-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-colors">Shift 1</button>
                        <button data-shift="2" class="shift-btn bg-gray-500 text-white py-2 px-5 rounded-lg font-semibold shadow-sm hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-gray-400 transition-colors">Shift 2</button>
                        <button data-shift="3" class="shift-btn bg-gray-500 text-white py-2 px-5 rounded-lg font-semibold shadow-sm hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-gray-400 transition-colors">Shift 3</button>
                    </div>
                </div>
            </div>
             <hr/>
            <div>
                <h2 class="text-lg font-semibold mb-3 text-gray-700">Mode Laporan Tersimpan</h2>
                 <div class="flex flex-wrap items-center gap-4">
                    <div>
                        <label for="report-date" class="block text-sm font-medium text-gray-700 mb-1">Pilih Tanggal Laporan:</label>
                        <input type="date" id="report-date" class="p-2 border rounded-md shadow-sm">
                    </div>
                    <button id="view-report-btn" class="self-end bg-indigo-600 text-white py-2 px-5 rounded-lg font-semibold shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-colors">
                        Tampilkan Laporan
                    </button>
                </div>
            </div>
        ...
        <div class="space-y-10">
            <div id="before-cleaning-section">
                <h3 class="text-2xl font-bold mb-4 text-gray-800 border-b-2 border-blue-500 pb-2">Filter SHC - Sebelum Pembersihan</h3>
                <div class="bg-white rounded-lg shadow-lg table-container">
                    <table class="w-full min-w-[900px]">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-100">
                            <tr>
                                <th class="px-4 py-3">Plot</th> <th class="px-4 py-3">SHC</th> <th class="px-4 py-3">Valve</th>
                                <th class="px-4 py-3">Inlet Pressure (bar)</th> <th class="px-4 py-3">Outlet Pressure (bar)</th>
                                <th class="px-4 py-3">Variance Inlet-outlet pressure (bar)</th> <th class="px-4 py-3">Needle Point</th> <th class="px-4 py-3">Foto (Maks 10)</th>
                            </tr>
                        </thead>
                        <tbody id="before-cleaning-tbody"></tbody>
                    </table>
                </div>
            </div>
            <div id="after-cleaning-section">
                <h3 class="text-2xl font-bold mb-4 text-gray-800 border-b-2 border-green-500 pb-2">Filter SHC - Setelah Pembersihan</h3>
                <div class="bg-white rounded-lg shadow-lg table-container">
                    <table class="w-full min-w-[900px]">
                         <thead class="text-xs text-gray-700 uppercase bg-gray-100">
                            <tr>
                                <th class="px-4 py-3">Plot</th> <th class="px-4 py-3">SHC</th> <th class="px-4 py-3">Valve</th>
                                <th class="px-4 py-3">Inlet Pressure (bar)</th> <th class="px-4 py-3">Outlet Pressure (bar)</th>
                                <th class="px-4 py-3">Variance Inlet-outlet pressure (bar)</th> <th class="px-4 py-3">Needle Point</th> <th class="px-4 py-3">Foto (Maks 3)</th>
                            </tr>
                        </thead>
                        <tbody id="after-cleaning-tbody"></tbody>
                    </table>
                </div>
            </div>
        </div>
        ...
        <div class="mt-10 flex justify-center items-center gap-4">
            <button id="save-btn" class="bg-blue-600 text-white py-3 px-8 rounded-lg font-bold shadow-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-transform transform hover:scale-105">
                Simpan Data
            </button>
            <button id="export-btn" class="bg-green-600 text-white py-3 px-8 rounded-lg font-bold shadow-lg hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 transition-transform transform hover:scale-105">
                Ekspor ke Excel (CSV)
            </button>
        </div>
    </div>
    ...
    <div id="image-modal" class="fixed inset-0 z-50 hidden items-center justify-center p-4">
        ...
        <div class="relative bg-white p-2 rounded-lg shadow-xl">
            <img id="modal-img" src="" alt="Tampilan Foto">
            <button onclick="closeImageModal()" class="absolute -top-2 -right-2 bg-white rounded-full p-1 shadow-lg">&times;</button>
        </div>
    </div>
